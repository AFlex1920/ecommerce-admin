    ...
    >
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link
          href={"/warehouse"}
          className={
            pathname.includes("/warehouse") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            stroke="currentColor"
            className={
              pathname.includes("/warehouse") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
        ...
        >
          <svg
            ...
            stroke="currentColor"
            className={
              pathname.includes("/reviews") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
        ...
        <Link
          href={"/discoun_code"}
          className={
            pathname.includes("/discoun_code") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            stroke="currentColor"
            className={
              pathname.includes("/discoun_code") ? activeIcon : inactiveIcon
            }
          >
            <path
